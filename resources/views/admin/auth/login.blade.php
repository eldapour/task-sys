...
<div class="container">
    <main class="signup-container" style="margin-top: 40px">
        ...
        <form class="signup-form" action="{{ Route::currentRouteName() == 'user.login'? route('user.dologin'): route('admin.login')}}" method="post" id="LoginForm">
            @csrf
            <label class="inp">
    ...
    <div class="welcome-container">
        <h1 class="heading-secondary">مرحبا بعودتك <span class="lg">{{ 'تطبيق مدير المهام '}}</span></h1>
    </div>
</div>
